    ...
    <div className="space-y-3">
      ...
      >
        ...
        >
          ...
          <span className="absolute inset-0 flex items-center justify-center rounded-full bg-stone-900/0 text-[10px] font-medium text-white opacity-0 transition touch:bg-stone-900/45 touch:opacity-100 group-hover:bg-stone-900/45 group-hover:opacity-100 group-focus-within:opacity-100 focus-visible:opacity-100">
            Change
          </span>
        </button>
              ...
              return (
                ...
                >
                  <img
                    ...
                    draggable={false}
                  />
                  <span className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-stone-900/55 to-transparent px-1.5 pb-1 pt-4 text-left text-[10px] font-medium text-white opacity-0 touch:opacity-100 transition group-hover:opacity-100 group-focus-within:opacity-100 focus-visible:opacity-100">
                    {a.label}
                  </span>
                </button>
              );
