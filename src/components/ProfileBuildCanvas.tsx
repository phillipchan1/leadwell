      ...
      <div className="relative z-[1] flex flex-1 flex-col gap-4 p-4">
        <div className="flex items-center gap-4">
          ...
          <div className="min-w-0 flex-1 space-y-2.5">
            ...
            <p className="profile-build__headline line-clamp-2 text-sm leading-snug text-tertiary">
        ...
        {howTo && (
          <div
            key={`h-${tick}`}
            className="profile-build__chip profile-build__chip--enter rounded-xl border-l-2 border-teal-500 bg-teal-50/40 px-3 py-2 text-xs text-tertiary dark:bg-teal-950/25"
          >
        ...
        {read.signals.length === 0 && (
          <div className="flex flex-1 flex-col items-center justify-center gap-2 py-8 text-center">
            ...
            <p className="max-w-[14rem] text-xs text-quaternary">
              {emptyHint ??
