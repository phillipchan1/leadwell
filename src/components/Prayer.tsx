...
export function PrayerCarryToggle({
    ...
    return (
      <span className="inline-flex shrink-0 items-center gap-0.5">
        ...
        <button
          ...
          onClick={layDown}
          className="rounded px-1 text-[10px] text-stone-400 opacity-0 transition-opacity touch:opacity-100 group-hover/person:opacity-100 group-focus-within/person:opacity-100 focus-visible:opacity-100 hover:text-stone-600 dark:text-stone-500 dark:hover:text-stone-400"
        >
          ×
        </button>
      </span>
  ...
  return (
    <button
      ...
      className="shrink-0 rounded px-1.5 py-0.5 text-[10px] font-medium text-violet-600 opacity-0 transition-opacity touch:opacity-100 group-hover/person:opacity-100 group-focus-within/person:opacity-100 focus-visible:opacity-100 hover:bg-violet-50 dark:text-violet-400 dark:hover:bg-violet-950/40"
    >
      Take up
    </button>
  );
